...
!function (a) {
    ...
    return function a(b, c, d) {
        ...
        3: [function (a, b) {
            ...
            var d = a("inherits"), e = a("./eventtarget");
            d(c, e), c.prototype.removeAllListeners = function (a) {
                ...
                var a = arguments[0], b = this._listeners[a];
                if (b) {
        ...
        4: [function (a, b) {
            ...
            }, c.CAPTURING_PHASE = 1, c.AT_TARGET = 2, c.BUBBLING_PHASE = 3, b.exports = c
        }, {}],
        5: [function (a, b) {
            "use strict";
            function c() {
            ...
            c.prototype.addEventListener = function (a, b) {
                ...
                -1 === c.indexOf(b) && (c = c.concat([b])), this._listeners[a] = c
                ...
                var a = arguments[0], b = a.type, c = 1 === arguments.length ? [a] : Array.apply(null, arguments);
                if (this["on" + b] && this["on" + b].apply(this, c), b in this._listeners)for (var d = this._listeners[b], e = 0; e < d.length; e++)d[e].apply(this, c)
            }, b.exports = c
        }, {}],
        6: [function (a, b) {
            "use strict";
        ...
        7: [function (a, b) {
            ...
            var d = a("json3"), e = a("./utils/iframe");
        ...
        8: [function (a, b) {
            "use strict";
            var c = a("./utils/url"), d = a("./utils/event"), e = a("json3"), f = a("./facade"), g = a("./info-iframe-receiver"), h = a("./utils/iframe"), i = a("./location");
        ...
        9: [function (a, b) {
            ...
            var d = a("events").EventEmitter, e = a("inherits"), f = a("json3"), g = a("./utils/object");
        ...
        10: [function (a, b) {
            ...
            var d = a("inherits"), e = a("events").EventEmitter, f = a("json3"), g = a("./transport/sender/xhr-local"), h = a("./info-ajax");
        ...
        11: [function (a, b) {
            (function (c) {
                ...
                var e = a("events").EventEmitter, f = a("inherits"), g = a("json3"), h = a("./utils/event"), i = a("./transport/iframe"), j = a("./info-iframe-receiver");
        ...
        12: [function (a, b) {
            ...
            var d = a("events").EventEmitter, e = a("inherits"), f = a("./utils/url"), g = a("./transport/sender/xdr"), h = a("./transport/sender/xhr-cors"), i = a("./transport/sender/xhr-local"), j = a("./transport/sender/xhr-fake"), k = a("./info-iframe"), l = a("./info-ajax");
        ...
        14: [function (a, b) {
            (function (c) {
                ...
                function d(a, b, c) {
                    ...
                    var e = c.sessionId || 8;
                    if ("function" == typeof e)this._generateSessionId = e; else {
                ...
                a("./shims");
                var f, g = a("url-parse"), h = a("inherits"), i = a("json3"), j = a("./utils/random"), k = a("./utils/escape"), l = a("./utils/url"), m = a("./utils/event"), n = a("./utils/transport"), o = a("./utils/object"), p = a("./utils/browser"), q = a("./utils/log"), r = a("./event/event"), s = a("./event/eventtarget"), t = a("./location"), u = a("./event/close"), v = a("./event/trans-message"), w = a("./info-receiver");
                h(d, s), d.prototype.close = function (a, b) {
                    ...
                    for (var a = this._transports.shift(); a; a = this._transports.shift()) {
                        ...
                        var d = l.addPath(this._transUrl, "/" + this._server + "/" + this._generateSessionId()), e = this._transportOptions[a.transportName], f = new a(d, this._transUrl, e);
                    ...
                    var b, c = this, d = a.slice(0, 1), e = a.slice(1);
                    switch (d) {
                        case"o":
        ...
        15: [function () {
            ...
            var d, e = Array.prototype, f = Object.prototype, g = Function.prototype, h = String.prototype, i = e.slice, j = f.toString, k = function (a) {
            ...
            var q = Object("a"), r = "a" !== q[0] || !(0 in q), s = function (a) {
                var b = !0, c = !0;
            ...
            o(e, {
                forEach: function (a) {
                    var b = p(this), c = r && m(this) ? this.split("") : b, d = arguments[1], e = -1, f = c.length >>> 0;
            ...
            o(e, {
                indexOf: function (b) {
                    var c = r && m(this) ? this.split("") : p(this), d = c.length >>> 0;
                    if (!d)return -1;
                    var e = 0;
            ...
            2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? !function () {
                ...
                h.split = function (c, d) {
                    ...
                    var g, h, i, k, l = [], m = (c.ignoreCase ? "i" : "") + (c.multiline ? "m" : "") + (c.extended ? "x" : "") + (c.sticky ? "y" : ""), n = 0;
                    for (c = new RegExp(c.source, m + "g"), f += "", a || (g = new RegExp("^" + c.source + "$(?!\\s)", m)), d = void 0 === d ? -1 >>> 0 : b(d); (h = c.exec(f)) && (i = h.index + h[0].length, !(i > n && (l.push(f.slice(n, h.index)), !a && h.length > 1 && h[0].replace(g, function () {
            ...
            var v = "\t\n\v\f\r   ᠎             　\u2028\u2029\ufeff", w = "​", x = "[" + v + "]", y = new RegExp("^" + x + x + "*"), z = new RegExp(x + x + "*$"), A = h.trim && (v.trim() || !w.trim());
            o(h, {
                trim: function () {
            ...
            var B = h.substr, C = "".substr && "b" !== "0b".substr(-1);
            o(h, {
                substr: function (a, b) {
        ...
        17: [function (a, b) {
            (function (c) {
                ...
                var e = a("events").EventEmitter, f = a("inherits"), g = a("../../utils/event"), h = a("../../utils/url"), i = c.XMLHttpRequest;
                f(d, e), d.prototype._start = function (a, b, c, e) {
                    ...
                    if (e && e.noCredentials || !d.supportsCORS || (this.xhr.withCredentials = "true"), e && e.headers)for (var j in e.headers)this.xhr.setRequestHeader(j, e.headers[j]);
                    ...
                    if (this.xhr) {
                        if (this.removeAllListeners(), g.unloadDel(this.unloadRef), this.xhr.onreadystatechange = function () {
        ...
        20: [function (a, b) {
            ...
            var d = a("inherits"), e = a("./lib/ajax-based"), f = a("./receiver/eventsource"), g = a("./sender/xhr-cors"), h = a("eventsource");
        ...
        21: [function (a, b) {
            ...
            var d = a("inherits"), e = a("./receiver/htmlfile"), f = a("./sender/xhr-local"), g = a("./lib/ajax-based");
        ...
        22: [function (a, b) {
            ...
            var d = a("inherits"), e = a("json3"), f = a("events").EventEmitter, g = a("../version"), h = a("../utils/url"), i = a("../utils/iframe"), j = a("../utils/event"), k = a("../utils/random");
            d(c, f), c.prototype.close = function () {
                ...
                this.iframeObj.post(e.stringify({windowId: this.windowId, type: a, data: b || ""}), this.origin)
        ...
        23: [function (a, b) {
            (function (c) {
                ...
                var e = a("inherits"), f = a("./lib/sender-receiver"), g = a("./receiver/jsonp"), h = a("./sender/jsonp");
        ...
        24: [function (a, b) {
            ...
            function c(a) {
                return function (b, c, d) {
                    var e = {};
                    "string" == typeof c && (e.headers = {"Content-type": "text/plain"});
                    var g = f.addPath(b, "/xhr_send"), h = new a("POST", g, c, e);
            ...
            var e = a("inherits"), f = a("../../utils/url"), g = a("./sender-receiver");
            e(d, g), b.exports = d
        ...
        25: [function (a, b) {
            ...
            var d = a("inherits"), e = a("events").EventEmitter;
        ...
        26: [function (a, b) {
            (function (c) {
                "use strict";
                var d = a("inherits"), e = a("../iframe"), f = a("../../utils/object");
        ...
        27: [function (a, b) {
            ...
            d(c, e), c.prototype._scheduleReceiver = function () {
                var a = this, b = this.poll = new this.Receiver(this.receiveUrl, this.AjaxObject);
        ...
        28: [function (a, b) {
            ...
            var d = a("inherits"), e = a("../../utils/url"), f = a("./buffered-sender"), g = a("./polling");
            d(c, f), c.prototype.close = function () {
        ...
        29: [function (a, b) {
            ...
            var d = a("inherits"), e = a("events").EventEmitter, f = a("eventsource");
        ...
        30: [function (a, b) {
            (function (c) {
                ...
                var e = a("inherits"), f = a("../../utils/iframe"), g = a("../../utils/url"), h = a("events").EventEmitter, i = a("../../utils/random");
        ...
        31: [function (a, b) {
            (function (c) {
                ...
                var e = a("../../utils/iframe"), f = a("../../utils/random"), g = a("../../utils/browser"), h = a("../../utils/url"), i = a("inherits"), j = a("events").EventEmitter;
                i(d, j), d.prototype.abort = function () {
                    ...
                    var b, d = this, e = this.script = c.document.createElement("script");
                    if (e.id = "a" + f.string(8), e.src = a, e.type = "text/javascript", e.charset = "UTF-8", e.onerror = this._scriptError.bind(this), e.onload = function () {
                        ...
                        }, "undefined" == typeof e.async && c.document.attachEvent)if (g.isOpera())b = this.script2 = c.document.createElement("script"), b.text = "try{var a = document.getElementById('" + e.id + "'); if(a)a.onerror();}catch(x){};", e.async = b.async = !1; else {
                        try {
        ...
        32: [function (a, b) {
            ...
            d(c, e), c.prototype._chunkHandler = function (a, b) {
                if (200 === a && b)for (var c = -1; ; this.bufferPosition += c + 1) {
        ...
        33: [function (a, b) {
            (function (c) {
                ...
                var f, g, h = a("../../utils/random"), i = a("../../utils/url");
        ...
        34: [function (a, b) {
            (function (c) {
                ...
                var e = a("events").EventEmitter, f = a("inherits"), g = a("../../utils/event"), h = a("../../utils/browser"), i = a("../../utils/url");
                f(d, e), d.prototype._start = function (a, b, d) {
                    var e = this, f = new c.XDomainRequest;
        ...
        35: [function (a, b) {
            ...
            var d = a("inherits"), e = a("../driver/xhr");
        ...
        37: [function (a, b) {
            "use strict";
            function c(a, b, c) {
                e.call(this, a, b, c, {noCredentials: !0})
            }
        ...
        38: [function (a, b) {
            ...
            function c(a, b, f) {
                if (!c.enabled())throw new Error("Transport created when disabled");
                g.call(this);
                var i = this, j = e.addPath(a, "/websocket");
            ...
            var d = a("../utils/event"), e = a("../utils/url"), f = a("inherits"), g = a("events").EventEmitter, h = a("./driver/websocket");
        ...
        39: [function (a, b) {
            ...
            var d = a("inherits"), e = a("./lib/ajax-based"), f = a("./xdr-streaming"), g = a("./receiver/xhr"), h = a("./sender/xdr");
        ...
        40: [function (a, b) {
            ...
            var d = a("inherits"), e = a("./lib/ajax-based"), f = a("./receiver/xhr"), g = a("./sender/xdr");
        ...
        41: [function (a, b) {
            ...
            var d = a("inherits"), e = a("./lib/ajax-based"), f = a("./receiver/xhr"), g = a("./sender/xhr-cors"), h = a("./sender/xhr-local");
            d(c, e), c.enabled = function (a) {
        ...
        42: [function (a, b) {
            (function (c) {
                ...
                var e = a("inherits"), f = a("./lib/ajax-based"), g = a("./receiver/xhr"), h = a("./sender/xhr-cors"), i = a("./sender/xhr-local"), j = a("../utils/browser");
        ...
        45: [function (a, b) {
            "use strict";
            var c, d = a("json3"), e = /[\x00-\x1f\ud800-\udfff\ufffe\uffff\u0300-\u0333\u033d-\u0346\u034a-\u034c\u0350-\u0352\u0357-\u0358\u035c-\u0362\u0374\u037e\u0387\u0591-\u05af\u05c4\u0610-\u0617\u0653-\u0654\u0657-\u065b\u065d-\u065e\u06df-\u06e2\u06eb-\u06ec\u0730\u0732-\u0733\u0735-\u0736\u073a\u073d\u073f-\u0741\u0743\u0745\u0747\u07eb-\u07f1\u0951\u0958-\u095f\u09dc-\u09dd\u09df\u0a33\u0a36\u0a59-\u0a5b\u0a5e\u0b5c-\u0b5d\u0e38-\u0e39\u0f43\u0f4d\u0f52\u0f57\u0f5c\u0f69\u0f72-\u0f76\u0f78\u0f80-\u0f83\u0f93\u0f9d\u0fa2\u0fa7\u0fac\u0fb9\u1939-\u193a\u1a17\u1b6b\u1cda-\u1cdb\u1dc0-\u1dcf\u1dfc\u1dfe\u1f71\u1f73\u1f75\u1f77\u1f79\u1f7b\u1f7d\u1fbb\u1fbe\u1fc9\u1fcb\u1fd3\u1fdb\u1fe3\u1feb\u1fee-\u1fef\u1ff9\u1ffb\u1ffd\u2000-\u2001\u20d0-\u20d1\u20d4-\u20d7\u20e7-\u20e9\u2126\u212a-\u212b\u2329-\u232a\u2adc\u302b-\u302c\uaab2-\uaab3\uf900-\ufa0d\ufa10\ufa12\ufa15-\ufa1e\ufa20\ufa22\ufa25-\ufa26\ufa2a-\ufa2d\ufa30-\ufa6d\ufa70-\ufad9\ufb1d\ufb1f\ufb2a-\ufb36\ufb38-\ufb3c\ufb3e\ufb40-\ufb41\ufb43-\ufb44\ufb46-\ufb4e\ufff0-\uffff]/g, f = function (a) {
                var b, c = {}, d = [];
        ...
        46: [function (a, b) {
            (function (c) {
                "use strict";
                var d = a("./random"), e = {}, f = !1, g = c.chrome && c.chrome.app && c.chrome.app.runtime;
                b.exports = {
        ...
        47: [function (a, b) {
            (function (c) {
                "use strict";
                var d = a("./event"), e = a("json3"), f = a("./browser");
                b.exports = {
                    WPrefix: "_jp", currentWindowId: null, polluteGlobalNamespace: function () {
                        ...
                        var e, f, g = c.document.createElement("iframe"), h = function () {
                            clearTimeout(e);
                            try {
                                g.onload = null
                            } catch (a) {
                        ...
                        return g.src = a, g.style.display = "none", g.style.position = "absolute", g.onerror = function () {
                            ...
                            j("timeout")
                        }, 15e3), f = d.unloadAdd(i), {post: k, cleanup: i, loaded: h}
                    }, createHtmlfile: function (a, e) {
                        var f, g, h, i = ["Active"].concat("Object").join("X"), j = new c[i]("htmlfile"), k = function () {
                        ...
                        return j.body.appendChild(o), h = j.createElement("iframe"), o.appendChild(h), h.src = a, h.onerror = function () {
                            ...
                            m("timeout")
                        }, 15e3), g = d.unloadAdd(l), {post: n, cleanup: l, loaded: k}
                    }
        ...
        50: [function (a, b) {
            "use strict";
            var c = a("crypto"), d = "abcdefghijklmnopqrstuvwxyz012345";
            b.exports = {
                string: function (a) {
                    ...
                    var b = ("" + (a - 1)).length, c = new Array(b + 1).join("0");
                        ...
                        if (!c("json")) {
                            ...
                            if ((o = r.hasOwnProperty) || (o = function (a) {
                                ...
                                var E = {
                                    ...
                                    if ("object" == typeof h && h)if (i = s.call(h), i != v || o.call(h, "toJSON"))"function" == typeof h.toJSON && (i != w && i != x && i != y || o.call(h, "toJSON")) && (h = h.toJSON(a)); else if (h > -1 / 0 && 1 / 0 > h) {
                                        if (D) {
                            ...
                            if (!c("json-parse")) {
                                var K, L, M = f.fromCharCode, N = {
                                    ...
                                    for (var a, b, c, d, e, f = L, g = f.length; g > K;)switch (e = f.charCodeAt(K)) {
                                        ...
                                        case 34:
                                            for (a = "@", K++; g > K;)if (e = f.charCodeAt(K), 32 > e)O(); else if (92 == e)switch (e = f.charCodeAt(++K)) {
                                                case 92:
                                                case 34:
                                                case 47:
                                                case 98:
        ...
        56: [function (a, b) {
            ...
            function c(a) {
                var b = i.exec(a);
                return {protocol: b[1] ? b[1].toLowerCase() : "", slashes: !!b[2], rest: b[3] ? b[3] : ""}
            }

            function d(a, b, i) {
                if (!(this instanceof d))return new d(a, b, i);
                var k, l, m, n, o = h.test(a), p = typeof b, q = this, r = 0;
            ...
            var e = a("requires-port"), f = a("./lolcation"), g = a("querystringify"), h = /^\/(?!\/)/, i = /^([a-z0-9.+-]+:)?(\/\/)?(.*)$/i, j = [["#", "hash"], ["?", "query"], ["/", "pathname"], ["@", "auth", 1], [NaN, "host", void 0, 1, 1], [/\:(\d+)$/, "port"], [NaN, "hostname", void 0, 1, 1]];
        ...
        57: [function (a, b) {
            (function (c) {
                "use strict";
                var d, e = /^[A-Za-z][A-Za-z0-9+-.]*:\/\//, f = {hash: 1, query: 1};
                b.exports = function (b) {
                    b = b || c.location || {}, d = d || a("./");
                    var g, h = {}, i = typeof b;
                    if ("blob:" === b.protocol)h = new d(unescape(b.pathname), {}); else if ("string" === i) {
                        h = new d(b, {});
     ...
     */
    function () {
        var a, b, c, d, e = {}.hasOwnProperty, f = [].slice;
        a = {LF: "\n", NULL: "\0"}, c = function () {
            function b(a, b, c) {
            ...
            return b.prototype.toString = function () {
                ...
                if (d = "", n = g + 2, i["content-length"])l = parseInt(i["content-length"]), d = ("" + c).substring(n, n + l); else for (e = null, j = q = n, t = c.length; (n <= t ? q < t : q > t) && (e = c.charAt(j), e !== a.NULL); j = n <= t ? ++q : --q)d += e;
                return new b(f, i, d)
            ...
            return b.prototype.debug = function (a) {
                ...
                return delete this.subscriptions[a], this._transmit("UNSUBSCRIBE", {id: a})
            }, b.prototype.begin = function (a) {
                var b, c;
                return c = a || "tx-" + this.counter++, this._transmit("BEGIN", {transaction: c}), b = this, {
                    id: c,
                    commit: function () {
                        return b.commit(c)
                    },
                ...
                return this._transmit("COMMIT", {transaction: a})
            }, b.prototype.abort = function (a) {
                return this._transmit("ABORT", {transaction: a})
